...
const PATHS = {
  ...
  eyeOff: <><path d="m3 3 18 18" /><path d="M10.6 5.6A10.8 10.8 0 0 1 12 5.5c6.4 0 10 6.5 10 6.5a19.4 19.4 0 0 1-3.1 3.9" /><path d="M6.7 6.7C3.8 8.4 2 12 2 12s3.6 6.5 10 6.5a10.6 10.6 0 0 0 3.2-.5" /><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2" /></>,
